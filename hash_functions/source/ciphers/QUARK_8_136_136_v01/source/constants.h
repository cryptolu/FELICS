...
#define DIGEST_SIZE 17 /* Replace with hash digest size */
#define BLOCK_SIZE 1 /* Replace with hash block size */
#define STATE_SIZE 17 /* Replace with hash state size */
#define NO_OF_ROUNDS 544 /* Replace with number of rounds in hash compression */

#define TEST_MESSAGE_SIZE BLOCK_SIZE

#define SPONGE TRUE

extern RAM_DATA_BYTE IV[17];
