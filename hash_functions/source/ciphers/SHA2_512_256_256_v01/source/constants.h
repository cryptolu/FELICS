...
#define STATE_SIZE 99   /* Replace with hash state size */
#define NO_OF_ROUNDS 64 /* Replace with number of rounds in hash compression */

#define TEST_MESSAGE_SIZE 18

#define SPONGE FALSE

#define SKIP_STATE_CHECK_INI SKIP_STATE_CHECK_TRUE
#define SKIP_STATE_CHECK_UPD SKIP_STATE_CHECK_TRUE
