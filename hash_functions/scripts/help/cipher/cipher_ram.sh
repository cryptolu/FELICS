...
function display_help()
{
	...
	echo " 	./cipher_ram.sh [{-h|--help}] [--version] [{-m|--mode}=[0|1]] [{-s|--scenario}=[0|1A|1B|1C|2]] [{-a|--architecture}=[PC|AVR|MSP|ARM]] [{-t|--target}=[...]] [{-o|--output}=[...]] [{-b|build}=[0|1]] [{-co|--compiler_options}='...']"
	echo ""
	...
	echo "		./cipher_ram.sh -t=./../../source/ciphers/HashName_BlockSizeInBits_StateSizeInBits_DigestSizeInBits_v01/build"
	echo ""
