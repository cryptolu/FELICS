...
function display_help()
{
	...
	echo " 	./check_ciphers.sh [{-h|--help}] [--version] [{-v|--verbosity}=[0|1|2]] [{-a|--architectures}=['PC AVR MSP ARM']] [{-s|--scenarios}=['0 1A 1B 1C 2']] [{-c|--ciphers}=['Cipher1 Cipher2 ...']] [{-co|--compiler_options}='...']"
	echo ""
	echo "	Options:"
	echo "		-h, --help"
	...
	echo "				List of values: '0 1A 1B 1C 2'"
	echo "				Default: all scenarios"
	echo "		-c, --ciphers"
	echo "			Specifies which ciphers to be checked for compliance"
	echo "				List of values: 'HashName_BlockSizeInBits_StateSizeInBits_DigestSizeInBits_v01 ...'"
	...
	echo "		./check_ciphers.sh -a='PC AVR' --scenarios=\"1 2\""
	echo ""
