...
{	
	...
	printf "\n" >> $output_file
	printf "   <NamedRange ss:Name=\"_FilterDatabase\" ss:RefersTo=\"=Ciphers!R1C1:R1C8\"" >> $output_file
	printf "\n" >> $output_file
	...
	printf "  <Table ss:ExpandedColumnCount=\"8\" x:FullColumns=\"1\"" >> $output_file
	printf "\n" >> $output_file
	...
	printf "\n" >> $output_file
	printf "   <Column ss:Width=\"120.75\"/>" >> $output_file
	printf "\n" >> $output_file
	printf "   <Column ss:Width=\"112.25\"/>" >> $output_file
	printf "\n" >> $output_file
	printf "   <Column ss:Width=\"112.25\"/>" >> $output_file
	printf "\n" >> $output_file
	printf "   <Column ss:Width=\"160.5\"/>" >> $output_file
	printf "\n" >> $output_file
	printf "   <Column ss:Width=\"346.5\"/>" >> $output_file
	printf "\n" >> $output_file
	printf "   <Column ss:Width=\"200.25\"/>" >> $output_file
	printf "\n" >> $output_file

	printf "   <Row>" >> $output_file
	printf "\n" >> $output_file
	printf "    <Cell ss:StyleID=\"s1\"><Data ss:Type=\"String\">Hash</Data><NamedCell" >> $output_file
	printf "\n" >> $output_file
	...
	printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
	printf "\n" >> $output_file
	printf "    <Cell ss:StyleID=\"s1\"><Data ss:Type=\"String\">State Size (bits)</Data><NamedCell" >> $output_file
	printf "\n" >> $output_file
	printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
	printf "\n" >> $output_file
	printf "    <Cell ss:StyleID=\"s1\"><Data ss:Type=\"String\">Digest Size (bits)</Data><NamedCell" >> $output_file
	printf "\n" >> $output_file
	printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
	printf "\n" >> $output_file
...
function add_xml_table_row()
{
	...
	printf "\n" >> $output_file
	printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"Number\">$hash_block_size</Data></Cell>" >> $output_file
	printf "\n" >> $output_file
	printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"Number\">$hash_state_size</Data></Cell>" >> $output_file
	printf "\n" >> $output_file
	printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"Number\">$hash_digest_size</Data></Cell>" >> $output_file
	printf "\n" >> $output_file
	printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"Number\">$hash_implementation_version</Data></Cell>" >> $output_file
	printf "\n" >> $output_file
	printf "    <Cell><Data ss:Type=\"String\">$hash_implementation_info</Data></Cell>" >> $output_file
	printf "\n" >> $output_file
	printf "    <Cell><Data ss:Type=\"String\">$hash_implementation_authors</Data></Cell>" >> $output_file
	printf "\n" >> $output_file
...
function add_xml_table_footer()
{
	...
	printf "  <AutoFilter x:Range=\"R1C1:R1C8\"" >> $output_file
	printf "\n" >> $output_file
