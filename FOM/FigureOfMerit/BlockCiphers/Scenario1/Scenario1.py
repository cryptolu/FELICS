...
class Scenario1:
    ...
    def read_csv_file(self, architecture):
        ...
        with open(file) as csv_file:
            ...
            for row in reader:
                ...
                if name in Constants.ALTERNATE_CIPHER_NAME:
                    name = Constants.ALTERNATE_CIPHER_NAME[name]
    ...
    def generate_latex_table(self):
        ...
        # f.write('\\scriptsize \n')
        # f.write('\\begin{center} \n')
        f.write('\\caption {Results for scenario 1. Encrypt and decrypt 128 bytes of data using CBC mode. For each '
                'cipher, an optimal implementation on each architecture is selected. The Figure-of-Merit (FOM) takes '
                'into account the three metrics (Code, RAM, and Time) on all platforms (AVR, MSP, and ARM). The '
                'smaller the FOM, the better the implementations of the cipher.} \label{tab:scen1a} \n')
        f.write('\\begin{tabular}{lrr|ccc|ccc|ccc|r} \n')
        f.write('\\toprule \n')
        f.write('\\textbf{Cipher} & \n')
        f.write('& \n')
        f.write('& \n')
        f.write('\\multicolumn{3}{c|}{\\textbf{AVR}} & \n')
        f.write('\\multicolumn{3}{c|}{\\textbf{MSP}} & \n')
        f.write('\\multicolumn{3}{c|}{\\textbf{ARM}} \\\\ \n')
        f.write('\\cmidrule(r){4-6} \cmidrule(r){7-9} \cmidrule(r){10-12} \n')
        f.write('& \n')
        f.write('\\thead{Block} & \n')
        f.write('\\thead{Key} & \n')
        f.write('\\thead{Code} & \n')
        ...
        # First section
        f.write('\\midrule \n')
        f.write('\\multicolumn{13}{c}{Encryption + Decryption (including key schedule)} \\\\ \n')
        f.write('\\midrule \n')

        for selected_cipher in self.selected_ciphers:
            block_size = selected_cipher.block_size
            key_size = selected_cipher.key_size
        ...
        f.write('\\caption {Results for scenario 1. Encrypt 128 bytes of data using CBC mode. For each cipher, an '
                'optimal implementation on each architecture is selected.} \label{tab:scen1b} \n')
        f.write('\\begin{tabular}{lrr|ccc|ccc|ccc} \n')
        f.write('\\toprule \n')
        f.write('\\textbf{Cipher} & \n')
        f.write('& \n')
        f.write('& \n')
        ...
        # Second section
        f.write('\\midrule \n')
        f.write('\\multicolumn{12}{c}{Encryption (without key schedule)} \\\\ \n')
        f.write('\\midrule \n')
        ...
        # f.write('\\scriptsize \n')
        # f.write('\\begin{center} \n')
        f.write('\\caption {Results for scenario 1. Decrypt 128 bytes of data using CBC mode. For each cipher, an '
                'optimal implementation on each architecture is selected.} \label{tab:scen1c} \n')
        f.write('\\begin{tabular}{lrr|ccc|ccc|ccc} \n')
        f.write('\\toprule \n')
        f.write('\\textbf{Cipher} & \n')
        f.write('& \n')
        ...
        f.write('\\multicolumn{3}{c|}{\\textbf{MSP}} & \n')
        f.write('\\multicolumn{3}{c|}{\\textbf{ARM}} \\\\ \n')
        f.write('\\cmidrule(r){4-6} \cmidrule(r){7-9} \cmidrule(r){10-11} \n')
        f.write('& \n')
        f.write('\\thead{Block} & \n')
        f.write('\\thead{Key} & \n')
        f.write('\\thead{Code} & \n')
        ...
        # Third section
        f.write('\\midrule \n')
        f.write('\\multicolumn{12}{c}{Decryption (without key schedule)} \\\\ \n')
        f.write('\\midrule \n')
    ...
    def generate_gnuplot_dat_file(self):
        ...
        self.selected_ciphers.sort(key=lambda c: c.name.lower())
