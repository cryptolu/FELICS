...
class Scenario2:
    ...
    def generate_latex_table(self):
        ...
        f.write('\\caption {Results for scenario 2. Encrypt 128 bits of data using CTR mode. For each cipher, an '
                'optimal implementation on each architecture is selected.  The Figure-of-Merit (FOM) takes into '
                'account the three metrics (Code, RAM, and Time) on all platforms (AVR, MSP, and ARM). The smaller the '
                'FOM, the better the implementations of the cipher.} \label{tab:scen2a} \n')
        ...
        # First section
        f.write('\\midrule \n')
        f.write('\\multicolumn{13}{c}{Balanced (globally efficient)} \\\\ \n')
        f.write('\\midrule \n')
        ...
        # Second section
        f.write('\\midrule \n')
        f.write('\\multicolumn{12}{c}{Small code size \\& RAM} \\\\ \n')
        f.write('\\midrule \n')
        ...
        # f.write('\\begin{center} \n')
        f.write('\\caption {Results for scenario 2. Encrypt 128 bits of data using CTR mode. For each cipher, an '
                'optimal implementation on each architecture is selected.} \label{tab:scen2c} \n')
        f.write('\\begin{tabular}{lrr|ccc|ccc|ccc} \n')
        f.write('\\toprule \n')
        f.write('\\textbf{Cipher} & \n')
        f.write('& \n')
        ...
        # Third section
        f.write('\\midrule \n')
        f.write('\\multicolumn{12}{c}{Best execution time} \\\\ \n')
        f.write('\\midrule \n')
