...
function add_xml_table_header()
{
    ...
    case $scenario in
        ...
        $SCRIPT_SCENARIO_2)
            printf "  <Names>" >> $output_file
            printf "\n" >> $output_file
            printf "   <NamedRange ss:Name=\"_FilterDatabase\" ss:RefersTo=\"=Results!R3C1:R3C10\"" >> $output_file
            printf "\n" >> $output_file
            printf "    ss:Hidden=\"1\"/>" >> $output_file
            printf "\n" >> $output_file
            printf "  </Names>" >> $output_file
            ...
            printf "  <Table ss:ExpandedColumnCount=\"10\" x:FullColumns=\"1\"" >> $output_file
            printf "\n" >> $output_file
            printf "   x:FullRows=\"1\" ss:DefaultRowHeight=\"15\">" >> $output_file
            printf "\n" >> $output_file
            ...
            printf "   <Column ss:Width=\"57.75\"/>" >> $output_file
            printf "\n" >> $output_file
            printf "   <Column ss:Width=\"73.5\"/>" >> $output_file
            printf "\n" >> $output_file
            printf "   <Column ss:Width=\"77.25\"/>" >> $output_file
            printf "\n" >> $output_file
            ...
            printf "      ss:Type=\"String\">Implementation Info</Data></Cell>" >> $output_file
            printf "\n" >> $output_file
            printf "    <Cell ss:MergeDown=\"1\" ss:StyleID=\"s1\"><Data ss:Type=\"String\">Code Size</Data></Cell>" >> $output_file
            printf "\n" >> $output_file
            printf "    <Cell ss:MergeAcross=\"1\" ss:StyleID=\"s1\"><Data ss:Type=\"String\">RAM</Data></Cell>" >> $output_file
            printf "\n" >> $output_file
            printf "    <Cell ss:MergeDown=\"1\" ss:StyleID=\"s1\"><Data ss:Type=\"String\">Execution Time</Data></Cell>" >> $output_file
            printf "\n" >> $output_file
            printf "   </Row>" >> $output_file
            printf "\n" >> $output_file
            printf "   <Row>" >> $output_file
            printf "\n" >> $output_file
            printf "    <Cell ss:Index=\"8\" ss:StyleID=\"s1\"><Data ss:Type=\"String\">Stack</Data></Cell>" >> $output_file
            printf "\n" >> $output_file
            printf "    <Cell ss:StyleID=\"s1\"><Data ss:Type=\"String\">Data</Data></Cell>" >> $output_file
            printf "\n" >> $output_file
            printf "   </Row>" >> $output_file
            printf "\n" >> $output_file
            ...
            printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
            printf "\n" >> $output_file
            printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"String\">Data (bytes)</Data><NamedCell" >> $output_file
            printf "\n" >> $output_file
            printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
            printf "\n" >> $output_file
            printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"String\">E (cycles)</Data><NamedCell" >> $output_file
...
function add_xml_table_footer()
{
    ...
    case $scenario in
        ...
        $SCRIPT_SCENARIO_2)
            ...
            printf "  <AutoFilter x:Range=\"R3C1:R3C10\"" >> $output_file
            printf "\n" >> $output_file
            printf "   xmlns=\"urn:schemas-microsoft-com:office:excel\">" >> $output_file
            printf "\n" >> $output_file
            printf "  </AutoFilter>" >> $output_file
