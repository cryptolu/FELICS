...
#define ROUND_KEYS_SIZE 144 /* Replace with the cipher round keys size in bytes */

#define NUMBER_OF_ROUNDS 36 /* Replace with the cipher number of rounds */
...
extern SBOX_BYTE SBOX[256];
extern SBOX_BYTE INV_SBOX[256];
extern ROUND_CONST_BYTE RC[36];
