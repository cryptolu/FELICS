 ...
 * SKINNY-64-128
 * @Time 2018
 * @Modification Zak (zakaria.najm@gmail.com)
 */
...
#define ROUND_CONST_BYTE ROM_DATA_BYTE
#define READ_ROUND_CONST_BYTE READ_ROM_DATA_BYTE
...
/* Replace with your custom data types and read macros for this architecture and scenario */
#define SBOX_BYTE ROM_DATA_BYTE __attribute__ ((aligned (256)))
...
#define SBOX_BYTE RAM_DATA_BYTE
#define READ_SBOX_BYTE READ_RAM_DATA_BYTE
#define ROUND_CONST_BYTE RAM_DATA_BYTE
#define READ_ROUND_CONST_BYTE READ_RAM_DATA_BYTE
