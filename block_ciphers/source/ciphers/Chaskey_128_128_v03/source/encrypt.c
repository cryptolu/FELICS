...
#endif
{
    ...
    asm (
        ...
        CHASKEY_ENC_ROUND(r17, r16, r15, r14, r13, r12, r11, r10, r9, r8, r7, r6, r5, r4, r3, r2, r20, r21, r28, r0, r1)
        ...
        : "r0", "r1", "r2", "r3", "r4", "r5", "r6", "r7", "r8", "r9", "r10", "r11", "r12", "r13", "r14", "r15", "r16", "r17", "r18", "r19", "r20", "r21", "r26", "r27", "r28", "r30", "r31"
#endif
    );
}
...
void Encrypt(uint8_t *block, uint8_t *roundKeys)
{
    ...
    asm volatile(
        ...
        CHASKEY_ENC_ROUND(r11, r10, r9, r8, r7, r6, r5, r4, r13)
        ...
        "xor r12, r11"                            "\n\t"
#else
        "mov -16(%[roundKeys]), r12"              "\n\t"
        "xor r12, r4"                             "\n\t"

        "mov -14(%[roundKeys]), r12"              "\n\t"
        "xor r12, r5"                             "\n\t"

        "mov -12(%[roundKeys]), r12"              "\n\t"
        "xor r12, r6"                             "\n\t"

        "mov -10(%[roundKeys]), r12"              "\n\t"
        "xor r12, r7"                             "\n\t"
