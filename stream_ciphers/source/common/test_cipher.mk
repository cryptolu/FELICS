...
.PHONY: help pc avr msp arm pc-scenario1 avr-scenario1 msp-scenario1 \
	arm-scenario1 cipher scenario1 test-cipher test-scenario1 upload-cipher \
	upload-scenario1 clean cleanall
...
help:
	...
	@echo -n        "scenario1|test-cipher|test-scenario1|upload-cipher|"
	@echo -n        "upload-scenario1|clean|cleanall]"
	@echo ""
	@echo ""
	@echo " Examples: "
...
# Run the ARM program on the board. Use only after upload-cipher or
#   upload-scenario1
run:
