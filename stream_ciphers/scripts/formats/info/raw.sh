...
function add_raw_table_header()
{
    ...
    printf " %"$title_position"s " "Stream Ciphers Implementation Info" >> $output_file
    printf "\n" >> $output_file
...
function add_raw_table_row()
{
    ...
    cipher_name="$cipher_name-$cipher_state_size;$cipher_key_size;$cipher_iv_size v$cipher_implementation_version"
