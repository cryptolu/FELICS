...
function add_xml_table_header()
{
    ...
    printf "\n" >> $output_file
    printf "   <NamedRange ss:Name=\"_FilterDatabase\" ss:RefersTo=\"=Ciphers!R1C1:R1C7\"" >> $output_file
    printf "\n" >> $output_file
    ...
    printf "  <Table ss:ExpandedColumnCount=\"7\" x:FullColumns=\"1\"" >> $output_file
    printf "\n" >> $output_file
    ...
    printf "\n" >> $output_file
    printf "   <Column ss:Width=\"102\"/>" >> $output_file
    printf "\n" >> $output_file
    printf "   <Column ss:Width=\"95.25\"/>" >> $output_file
    printf "\n" >> $output_file
    printf "   <Column ss:Width=\"87\"/>" >> $output_file
    printf "\n" >> $output_file
    ...
    printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
    printf "\n" >> $output_file
    printf "    <Cell ss:StyleID=\"s1\"><Data ss:Type=\"String\">IV Size (bits)</Data><NamedCell" >> $output_file
    printf "\n" >> $output_file
    printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
    printf "\n" >> $output_file
...
function add_xml_table_footer()
{
    ...
    printf "  <AutoFilter x:Range=\"R1C1:R1C7\"" >> $output_file
    printf "\n" >> $output_file
