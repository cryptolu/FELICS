...
function add_mediawiki_table_header()
{
    ...
    case $scenario in
        $SCRIPT_SCENARIO_0)
            ...
            printf "|-" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" colspan=\"4\" rowspan=\"2\" | Cipher Info" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" colspan=\"3\" rowspan=\"2\" | Implementation Info" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" colspan=\"3\" rowspan=\"2\" | Code Size" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" colspan=\"6\" | RAM" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" colspan=\"2\" rowspan=\"2\" | Execution Time" >> $output_file
            printf "\n" >> $output_file
            printf "|-" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" colspan=\"2\" | Stack" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" colspan=\"4\" | Data" >> $output_file
            printf "\n" >> $output_file
            printf "|-" >> $output_file
            printf "\n" >> $output_file
            ...
            printf "\n" >> $output_file
            printf "! scope=\"col\" | IV (bits)" >> $output_file
            printf "\n" >> $output_file
            ...
            printf "\n" >> $output_file
            printf "! scope=\"col\" | S (bytes)" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" | E (bytes)" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" | S+E (bytes)" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" | S (bytes)" >> $output_file
            printf "\n" >> $output_file
            printf "! scope=\"col\" | E (bytes)" >> $output_file
