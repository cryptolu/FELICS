...
TABLE_HORIZONTAL_LINE_LENGTH=110
TABLE_CIPHER_COLUMN_LENGTH=40
TABLE_INFO_COLUMN_LENGTH=36
TABLE_AUTHORS_COLUMN_LENGTH=24

IMPLEMENTATION_DESCRIPTION=ImplementationDescription
IMPLEMENTATION_AUTHORS=ImplementationAuthors
