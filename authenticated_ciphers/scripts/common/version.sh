...
FRAMEWORK_MODULE_NAME='Authenticated Encryption With Associated Data'
FRAMEWORK_MODULE_DIRECTORY='authenticated_ciphers'

COPYRIGHT="Copyright (C) 2019 University of Luxembourg"
