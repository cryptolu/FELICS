...
function add_raw_table_header()
{
    ...
    printf " %"$title_position"s " "Authenticated Ciphers Implementation Info" >> $output_file
    printf "\n" >> $output_file
...
function add_raw_table_row()
{
    ...
    cipher_name="$cipher_name-$cipher_block_size;$cipher_key_size;$cipher_nonce_size;$cipher_state_size;$cipher_tag_size v$cipher_implementation_version"
