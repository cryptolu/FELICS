...
function add_xml_table_header()
{
    ...
    printf "  <Table ss:ExpandedColumnCount=\"9\" x:FullColumns=\"1\"" >> $output_file
    printf "\n" >> $output_file
    ...
    printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
    printf "\n" >> $output_file
    printf "    <Cell ss:StyleID=\"s1\"><Data ss:Type=\"String\">Nonce Size (bits)</Data><NamedCell" >> $output_file
    printf "\n" >> $output_file
    printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
    printf "\n" >> $output_file
    ...
    printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
    printf "\n" >> $output_file
    printf "    <Cell ss:StyleID=\"s1\"><Data ss:Type=\"String\">Tag Size (bits)</Data><NamedCell" >> $output_file
    printf "\n" >> $output_file
    printf "      ss:Name=\"_FilterDatabase\"/></Cell>" >> $output_file
    printf "\n" >> $output_file
...
function add_xml_table_row()
{
    ...
    printf "\n" >> $output_file
    printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"Number\">$cipher_nonce_size</Data></Cell>" >> $output_file
    printf "\n" >> $output_file
    printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"Number\">$cipher_state_size</Data></Cell>" >> $output_file
    printf "\n" >> $output_file
    printf "    <Cell ss:StyleID=\"s2\"><Data ss:Type=\"Number\">$cipher_tag_size</Data></Cell>" >> $output_file
    printf "\n" >> $output_file
